...
ActiveRecord::Schema.define(version: 20170217154538) do
  ...
  create_table "applications", force: :cascade do |t|
    ...
    t.index ["experiment_id"], name: "index_applications_on_experiment_id"
    t.index ["participant_id"], name: "index_applications_on_participant_id"
    t.index ["slot_id"], name: "index_applications_on_slot_id"
  end
  ...
  create_table "slots", force: :cascade do |t|
    ...
    t.datetime "created_at",    null: false
    t.datetime "updated_at",    null: false
    t.index ["experiment_id"], name: "index_slots_on_experiment_id"
  end
